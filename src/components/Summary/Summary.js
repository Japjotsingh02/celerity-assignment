...
const Summary = ({data}) => {
  return (
    <div className="flex mx-10 justify-between mb-16 gap-20">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex gap-3">
          <BookingCard className="py-5 px-6">
            ...
            <div className="font-[700] text-[19px] text-center">114.21KG</div>
          </BookingCard>
          ...
          <BookingCard className="py-5 px-6 flex-1">
            ...
            <div className="flex justify-center items-center">
              ...
              <div>
                ...
                <div className="font-[700] text-[19px] text-center mt-2">{data.load}</div>
              </div>
            </div>
          </BookingCard>
        </div>
        ...
        <div className="flex gap-3">
          <BookingCard className="p-7 flex-1">
            <div>
              ...
              <span className="text-[#5C5C5C] font-[600] text-[17px]"> Primetime Worldwide</span>
            </div>
            <img src={frame} alt="weightScale"/>
          </BookingCard>

          <BookingCard className="p-7 flex-1">
            <div>
              <span className="text-[#5C5C5C] font-[600] text-[17px]">Insurance:</span>
              <span className="text-[#5C5C5C] font-[600] text-[17px]">Xcover.com</span>
            </div>
            <img src={xcover} alt="weightScale"/>
          </BookingCard>
        </div>
